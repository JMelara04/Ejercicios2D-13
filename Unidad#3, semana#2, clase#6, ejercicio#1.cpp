// Unidad 3, semana 2, clase 6, ejercicio 1 (Jennifer Melara 2D #13)
#include <iostream>
#include<stdlib.h>
#include<conio.h>
using namespace std;
main(){
	...
	opcion=getche();
	cout<<"\n\t Ingresa la cantiad de entradas requeridas: ";
	cin>>cantidad;
	if(cantidad<1){
		cout<<"\n\t\a ERROR: Cantidad de entradas deber ser mayor que 1"<<endl;
		system("PAUSE");
		return 0;
	}
	system("cls");
	switch(opcion){
		...
		case 'E': case 'e':
			...
			break;
		default:
			cout<<"\n\t\a ERROR: El secto seleccionado no existe"<<endl;
		system("PAUSE");
		return 0;
	}
